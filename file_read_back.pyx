...
cdef class FileReadBackwards:
    ...
    cdef str path, encoding
    cdef int chunk_size
    cdef iterator

    def __init__(self, str path, str encoding="utf-8", int chunk_size=io.DEFAULT_BUFFER_SIZE):
...
class FileReadBackwardsIterator:
    ...
    def __init__(self, fp, str encoding, int chunk_size):
